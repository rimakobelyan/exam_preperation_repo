...
from POM.TestingData import test_data
from POM.pages.home_page import HomePageFunctionality
from POM.pages.services_page import ServicePage
...
def get_driver(request, get_browser):
    ...
    request.cls.services_page = ServicePage(driver)
    driver.get(test_data.url)
    ## Add in here each pages from the POM in order to initialize the driver for each one.
    yield driver
    driver.quit()
