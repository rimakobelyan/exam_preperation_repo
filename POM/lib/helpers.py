...
class Helpers:
    ...
    def find(self, loc: object, timeout: object = 10, get_text: object = False, get_attribute: object = False) -> object:
    ...
    def find_and_click(self, loc: object, timeout: object = 10) -> object:
